    ...
    public class GesApproDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Fournisseur>()
                .HasMany(f => f.Approvisionnements)
                .WithOne(a => a.Fournisseur)
                .HasForeignKey(a => a.FournisseurId)
                .OnDelete(DeleteBehavior.Cascade);
                
            modelBuilder.Entity<ApprovisionnementArticle>()
                .HasOne(aa => aa.Approvisionnement)
            ...
            // Configurer les propriétés decimal pour avoir 2 décimales
            modelBuilder.Entity<ApprovisionnementArticle>()
                .Property(aa => aa.PrixUnitaire)
                .HasPrecision(18, 2);
                
            modelBuilder.Entity<ApprovisionnementArticle>()
                .Property(aa => aa.Montant)
                .HasPrecision(18, 2);
